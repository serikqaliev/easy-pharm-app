...
part of 'symptoms_network_provider.dart';
...
class _SymptomsNetworkProvider implements SymptomsNetworkProvider {
  _SymptomsNetworkProvider(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  @override
  Future<Symptom> create(SymptomDto symptom) async {
  ...
  @override
  Future<List<Symptom>> list() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
